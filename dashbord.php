...
<head>
    ...
    <title>SOLO KARATE CLUB | Semua Data</title>
              ...
              <ul class="nav metismenu" id="side-menu">
                  <li class="nav-header">
                      <div class="dropdown profile-element"> <span>
                          ...
                          <span class="clear"> <span class="block m-t-xs"> <strong class="font-bold">Abdul Rohim Bayu Aji Prayogo</strong>
                  ...
                  <li>
                      ...
                      <ul class="nav nav-second-level collapse">
                          <li><a href="kontingen.php">Manage Kontingen</a></li>
                          <li><a href="peserta.php">Manage Peserta</a></li>
                      </ul>
                  </li>
              </ul>
          </div>
